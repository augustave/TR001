          ...
          <div className="flex-[2] p-8 relative flex flex-col items-center justify-center min-h-[450px]">
            <svg viewBox="0 0 600 400" className="w-full h-full max-h-[400px] overflow-visible" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
              ...
              <g className="transition-opacity duration-300">
                <circle cx="180" cy="140" r="35" fill="#2B5E9D" className={`transition-opacity duration-300 ${activeZone === 1 ? 'opacity-20' : 'opacity-0'}`} />
                <circle cx="180" cy="260" r="35" fill="#2B5E9D" className={`transition-opacity duration-300 ${activeZone === 1 ? 'opacity-20' : 'opacity-0'}`} />

                <polygon points="350,110 470,110 510,200 470,290 350,290" fill="#2B5E9D" className={`transition-opacity duration-300 ${activeZone === 2 ? 'opacity-20' : 'opacity-0'}`} />

                <rect x="220" y="195" width="260" height="10" fill="#2B5E9D" className={`transition-opacity duration-300 ${activeZone === 3 ? 'opacity-30' : 'opacity-0'}`} />

                <polygon points="270,200 290,160 330,160 350,200 330,240 290,240" fill="#2B5E9D" className={`transition-opacity duration-300 ${activeZone === 4 ? 'opacity-30' : 'opacity-0'}`} />

                <polygon points="100,240 130,240 130,280 180,280 180,310 100,310" fill="#2B5E9D" className={`transition-opacity duration-300 ${activeZone === 5 ? 'opacity-30' : 'opacity-0'}`} />
              </g>

              {/* Hull Outlines */}
              <path d="M 80 200 L 250 40 L 450 40 L 530 200 L 450 360 L 250 360 Z" stroke="#1A1A1A" strokeWidth="3" fill="none" />
              <path d="M 120 200 L 270 70 L 430 70 L 490 200 L 430 330 L 270 330 Z" stroke="#1A1A1A" strokeWidth="2" fill="none" />
              <path d="M 160 200 L 290 100 L 410 100 L 450 200 L 410 300 L 290 300 Z" stroke="#1A1A1A" strokeWidth="2" fill="none" />

              {/* Components */}
              <circle cx="180" cy="140" r="30" stroke="#1A1A1A" strokeWidth="2" fill="none" />
              <line x1="160" y1="140" x2="200" y2="140" stroke="#1A1A1A" strokeWidth="2" />
              <line x1="180" y1="120" x2="180" y2="160" stroke="#1A1A1A" strokeWidth="2" />

              <circle cx="180" cy="260" r="30" stroke="#1A1A1A" strokeWidth="2" fill="none" />
              <line x1="160" y1="260" x2="200" y2="260" stroke="#1A1A1A" strokeWidth="2" />
              <line x1="180" y1="240" x2="180" y2="280" stroke="#1A1A1A" strokeWidth="2" />

              <polygon points="280,200 295,165 325,165 340,200 325,235 295,235" stroke="#1A1A1A" strokeWidth="2" fill="none" />

              <path d="M 90 240 L 140 240 L 140 280 L 190 280" stroke="#1A1A1A" strokeWidth="2" fill="none" />

              {/* Component Leader Lines */}
              <g stroke="#1A1A1A" strokeWidth="1.5" className="opacity-60">
              ...
              {/* Dimensions */}
              <line x1="80" y1="390" x2="530" y2="390" stroke="#C0392B" strokeWidth="2" markerStart="url(#s01-arrow-red-start)" markerEnd="url(#s01-arrow-red-end)" />
              <line x1="80" y1="370" x2="80" y2="400" stroke="#C0392B" strokeWidth="1" />
              <line x1="530" y1="370" x2="530" y2="400" stroke="#C0392B" strokeWidth="1" />
              <rect x="250" y="380" width="100" height="20" fill="#ffffff" />
              <text x="300" y="394" fontSize="14" fontWeight="bold" fill="#C0392B" textAnchor="middle" letterSpacing="1">L = 120.0</text>

              <line x1="30" y1="40" x2="30" y2="360" stroke="#C0392B" strokeWidth="2" markerStart="url(#s01-arrow-red-start)" markerEnd="url(#s01-arrow-red-end)" />
              <line x1="20" y1="40" x2="40" y2="40" stroke="#C0392B" strokeWidth="1" />
              <line x1="20" y1="360" x2="40" y2="360" stroke="#C0392B" strokeWidth="1" />
        ...
        <div className="flex flex-col lg:flex-row w-full">
          ...
          <div className="flex-[1.5] p-8 border-b lg:border-b-0 lg:border-r border-[#1A1A1A] relative flex flex-col items-center justify-center min-h-[300px]">
            <svg viewBox="0 0 500 250" className="w-full h-full max-h-[250px] overflow-visible" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
              ...
              <circle cx="80" cy="170" r="12" stroke="#2B5E9D" strokeWidth="2" strokeDasharray="4,4" fill="none" />
              <circle cx="280" cy="140" r="16" stroke="#2B5E9D" strokeWidth="2" strokeDasharray="4,4" fill="none" />
              <circle cx="340" cy="175" r="12" stroke="#2B5E9D" strokeWidth="2" strokeDasharray="4,4" fill="none" />

              <path d="M 60 180 L 280 140 L 380 140 L 400 80 L 430 80 L 430 140 L 460 140 L 470 180 Z" stroke="#1A1A1A" strokeWidth="3" fill="none" />
              <path d="M 380 140 L 400 180" stroke="#1A1A1A" strokeWidth="2" fill="none" />

              <line x1="60" y1="220" x2="470" y2="220" stroke="#C0392B" strokeWidth="2" markerStart="url(#s01-arrow-red-start-prof)" markerEnd="url(#s01-arrow-red-end-prof)" />
              <line x1="60" y1="190" x2="60" y2="230" stroke="#C0392B" strokeWidth="1" />
              <line x1="470" y1="190" x2="470" y2="230" stroke="#C0392B" strokeWidth="1" />
              <rect x="220" y="210" width="100" height="20" fill="#ffffff" />
              <text x="270" y="224" fontSize="14" fontWeight="bold" fill="#C0392B" textAnchor="middle" letterSpacing="1">LOA = 120.0</text>

              <line x1="200" y1="140" x2="200" y2="180" stroke="#C0392B" strokeWidth="2" markerStart="url(#s01-arrow-red-start-prof)" markerEnd="url(#s01-arrow-red-end-prof)" />
              <rect x="110" y="150" width="180" height="20" fill="#ffffff" />
              <text x="200" y="164" fontSize="12" fontWeight="bold" fill="#C0392B" textAnchor="middle" letterSpacing="1">DECK + FREEBOARD = 11.0</text>

              <line x1="440" y1="80" x2="440" y2="180" stroke="#C0392B" strokeWidth="2" markerStart="url(#s01-arrow-red-start-prof)" markerEnd="url(#s01-arrow-red-end-prof)" />
              <rect x="445" y="120" width="55" height="20" fill="#ffffff" />
              <text x="470" y="134" fontSize="12" fontWeight="bold" fill="#C0392B" textAnchor="middle" letterSpacing="1">MAST = 26.0</text>
          ...
          <div className="flex-[1] flex flex-col">
            ...
            <div className="flex-1 p-8 relative flex flex-col items-center justify-center min-h-[250px]">
              <svg viewBox="0 0 400 250" className="w-full h-full max-h-[250px] overflow-visible" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
                ...
                <circle cx="200" cy="140" r="16" stroke="#2B5E9D" strokeWidth="2" strokeDasharray="4,4" fill="none" />
                <circle cx="200" cy="180" r="20" stroke="#2B5E9D" strokeWidth="2" strokeDasharray="4,4" fill="none" />
                <circle cx="310" cy="90" r="16" stroke="#2B5E9D" strokeWidth="2" strokeDasharray="4,4" fill="none" />

                <path d="M 80 180 L 100 130 L 160 130 A 40 40 0 0 1 240 130 L 300 130 L 320 180 Z" stroke="#1A1A1A" strokeWidth="3" fill="none" />

                <path d="M 100 130 L 70 80 L 100 80 L 120 110" stroke="#1A1A1A" strokeWidth="3" fill="none" />
                <path d="M 300 130 L 330 80 L 300 80 L 280 110" stroke="#1A1A1A" strokeWidth="3" fill="none" />

                <line x1="80" y1="220" x2="320" y2="220" stroke="#C0392B" strokeWidth="2" markerStart="url(#s01-arrow-red-start-prof)" markerEnd="url(#s01-arrow-red-end-prof)" />
                <line x1="80" y1="190" x2="80" y2="230" stroke="#C0392B" strokeWidth="1" />
                <line x1="320" y1="190" x2="320" y2="230" stroke="#C0392B" strokeWidth="1" />
                <rect x="150" y="210" width="100" height="20" fill="#ffffff" />
                <text x="200" y="224" fontSize="14" fontWeight="bold" fill="#C0392B" textAnchor="middle" letterSpacing="1">BEAM = 52.0</text>

                <line x1="330" y1="80" x2="330" y2="140" stroke="#C0392B" strokeWidth="1" />
                <path d="M 330 110 A 30 30 0 0 0 315 100" stroke="#C0392B" strokeWidth="2" fill="none" markerEnd="url(#s01-arrow-red-end-prof)" />
                <rect x="335" y="100" width="120" height="20" fill="#ffffff" />
                <text x="390" y="114" fontSize="12" fontWeight="bold" fill="#C0392B" textAnchor="middle" letterSpacing="1">FIN CANT = 35°</text>
